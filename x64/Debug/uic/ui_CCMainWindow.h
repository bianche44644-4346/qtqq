...
public:
    ...
    void setupUi(QWidget *CCMainWindowClass)
    {
        ...
        CCMainWindowClass->setMaximumSize(QSize(16777215, 16777214));
        ...
        placehold1->setObjectName(QStringLiteral("placehold1"));
        ...
        headLabel->setFrameShape(QFrame::NoFrame);
...
"font:75 12pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        ...
        bottomWidget->setProperty("buttomskin", QVariant(true));
    ...
    void retranslateUi(QWidget *CCMainWindowClass)
    {
        ...
        nameLabel->setText(QApplication::translate("CCMainWindowClass", "\345\276\256\351\206\272", Q_NULLPTR));
