...
QT_MOC_LITERAL(4, 42, 13), // "veryfyAccount"
QT_MOC_LITERAL(5, 56, 5), // "bool&"
QT_MOC_LITERAL(6, 62, 14), // "isAccountLogin"
QT_MOC_LITERAL(7, 77, 8), // "QString&"
QT_MOC_LITERAL(8, 86, 10) // "strAccount"

    },
    "UserLogin\0onLoginBtnClicked\0\0connectMysql\0"
    "veryfyAccount\0bool&\0isAccountLogin\0"
    "QString&\0strAccount"
};
...
void UserLogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->veryfyAccount((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
